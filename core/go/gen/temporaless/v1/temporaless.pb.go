...
type WorkflowOptions struct {
	...
	CodeVersion string `protobuf:"bytes,3,opt,name=code_version,json=codeVersion,proto3" json:"code_version,omitempty"`
...
type ActivityRecord struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SchemaVersion RecordSchemaVersion    `protobuf:"varint,1,opt,name=schema_version,json=schemaVersion,proto3,enum=temporaless.v1.RecordSchemaVersion" json:"schema_version,omitempty"`
	Key           *ActivityKey           `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
	...
	Status      ActivityStatus `protobuf:"varint,7,opt,name=status,proto3,enum=temporaless.v1.ActivityStatus" json:"status,omitempty"`
	// Set when status is COMPLETED.
	Result *anypb.Any `protobuf:"bytes,8,opt,name=result,proto3" json:"result,omitempty"`
	// Set when status is FAILED.
	Failure     *ActivityFailure       `protobuf:"bytes,9,opt,name=failure,proto3" json:"failure,omitempty"`
...
type WorkflowRecord struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SchemaVersion RecordSchemaVersion    `protobuf:"varint,1,opt,name=schema_version,json=schemaVersion,proto3,enum=temporaless.v1.RecordSchemaVersion" json:"schema_version,omitempty"`
	Key           *WorkflowKey           `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
	WorkflowType  string                 `protobuf:"bytes,3,opt,name=workflow_type,json=workflowType,proto3" json:"workflow_type,omitempty"`
	CodeVersion   string                 `protobuf:"bytes,4,opt,name=code_version,json=codeVersion,proto3" json:"code_version,omitempty"`
	InputDigest   string                 `protobuf:"bytes,5,opt,name=input_digest,json=inputDigest,proto3" json:"input_digest,omitempty"`
	Input         *anypb.Any             `protobuf:"bytes,6,opt,name=input,proto3" json:"input,omitempty"`
	Status        WorkflowStatus         `protobuf:"varint,7,opt,name=status,proto3,enum=temporaless.v1.WorkflowStatus" json:"status,omitempty"`
	// Set when status is COMPLETED.
	Result *anypb.Any `protobuf:"bytes,8,opt,name=result,proto3" json:"result,omitempty"`
	// Set when status is FAILED.
	Failure   *ActivityFailure       `protobuf:"bytes,9,opt,name=failure,proto3" json:"failure,omitempty"`
...
type TimerRecord struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SchemaVersion RecordSchemaVersion    `protobuf:"varint,1,opt,name=schema_version,json=schemaVersion,proto3,enum=temporaless.v1.RecordSchemaVersion" json:"schema_version,omitempty"`
	Key           *TimerKey              `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
	TimerKind     TimerKind              `protobuf:"varint,3,opt,name=timer_kind,json=timerKind,proto3,enum=temporaless.v1.TimerKind" json:"timer_kind,omitempty"`
	CodeVersion   string                 `protobuf:"bytes,4,opt,name=code_version,json=codeVersion,proto3" json:"code_version,omitempty"`
	InputDigest   string                 `protobuf:"bytes,5,opt,name=input_digest,json=inputDigest,proto3" json:"input_digest,omitempty"`
	// Original duration the workflow body asked to sleep for.
	Duration *durationpb.Duration `protobuf:"bytes,6,opt,name=duration,proto3" json:"duration,omitempty"`
	Status   TimerStatus          `protobuf:"varint,7,opt,name=status,proto3,enum=temporaless.v1.TimerStatus" json:"status,omitempty"`
	// Wall-clock instant at which the timer becomes due. Schedulers compare this
	// against `now` to find re-invocations to dispatch.
	FireAt    *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=fire_at,json=fireAt,proto3" json:"fire_at,omitempty"`
...
type EventRecord struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SchemaVersion RecordSchemaVersion    `protobuf:"varint,1,opt,name=schema_version,json=schemaVersion,proto3,enum=temporaless.v1.RecordSchemaVersion" json:"schema_version,omitempty"`
	Key           *EventKey              `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
...
type ClaimRecord struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SchemaVersion RecordSchemaVersion    `protobuf:"varint,1,opt,name=schema_version,json=schemaVersion,proto3,enum=temporaless.v1.RecordSchemaVersion" json:"schema_version,omitempty"`
	Key           *ClaimKey              `protobuf:"bytes,2,opt,name=key,proto3" json:"key,omitempty"`
	// Caller-supplied identity. The runtime checks this on resume to confirm
	// that the resumer owns the claim.
	OwnerId      string            `protobuf:"bytes,3,opt,name=owner_id,json=ownerId,proto3" json:"owner_id,omitempty"`
	ResourceType ClaimResourceType `protobuf:"varint,4,opt,name=resource_type,json=resourceType,proto3,enum=temporaless.v1.ClaimResourceType" json:"resource_type,omitempty"`
	// Domain ID of the resource being claimed (activity_id, timer_id, etc.).
	ResourceId     string                 `protobuf:"bytes,5,opt,name=resource_id,json=resourceId,proto3" json:"resource_id,omitempty"`
	CodeVersion    string                 `protobuf:"bytes,6,opt,name=code_version,json=codeVersion,proto3" json:"code_version,omitempty"`
...
type GetWorkflowRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           *WorkflowKey           `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetWorkflowResponse struct {
	...
	Record        *WorkflowRecord `protobuf:"bytes,2,opt,name=record,proto3" json:"record,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PutWorkflowRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Record        *WorkflowRecord        `protobuf:"bytes,1,opt,name=record,proto3" json:"record,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetTimerRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           *TimerKey              `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetTimerResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Found         bool                   `protobuf:"varint,1,opt,name=found,proto3" json:"found,omitempty"`
	Record        *TimerRecord           `protobuf:"bytes,2,opt,name=record,proto3" json:"record,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PutTimerRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Record        *TimerRecord           `protobuf:"bytes,1,opt,name=record,proto3" json:"record,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetActivityRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Key           *ActivityKey           `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetActivityResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Found         bool                   `protobuf:"varint,1,opt,name=found,proto3" json:"found,omitempty"`
	Record        *ActivityRecord        `protobuf:"bytes,2,opt,name=record,proto3" json:"record,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type PutActivityRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Record        *ActivityRecord        `protobuf:"bytes,1,opt,name=record,proto3" json:"record,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetEventResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Found         bool                   `protobuf:"varint,1,opt,name=found,proto3" json:"found,omitempty"`
	Record        *EventRecord           `protobuf:"bytes,2,opt,name=record,proto3" json:"record,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListWorkflowsRequest struct {
	...
	Status WorkflowStatus `protobuf:"varint,2,opt,name=status,proto3,enum=temporaless.v1.WorkflowStatus" json:"status,omitempty"`
...
type ListWorkflowsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Records       []*WorkflowRecord      `protobuf:"bytes,1,rep,name=records,proto3" json:"records,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListActivitiesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Records       []*ActivityRecord      `protobuf:"bytes,1,rep,name=records,proto3" json:"records,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListTimersRequest struct {
	...
	Status        TimerStatus `protobuf:"varint,2,opt,name=status,proto3,enum=temporaless.v1.TimerStatus" json:"status,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListTimersResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Records       []*TimerRecord         `protobuf:"bytes,1,rep,name=records,proto3" json:"records,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetClaimResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Found         bool                   `protobuf:"varint,1,opt,name=found,proto3" json:"found,omitempty"`
	Record        *ClaimRecord           `protobuf:"bytes,2,opt,name=record,proto3" json:"record,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetStoreCapabilitiesResponse struct {
	...
	ClaimCapability ClaimCapability `protobuf:"varint,1,opt,name=claim_capability,json=claimCapability,proto3,enum=temporaless.v1.ClaimCapability" json:"claim_capability,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
type DueTimer struct {
	...
	Key           *TimerKey              `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	Record        *TimerRecord           `protobuf:"bytes,2,opt,name=record,proto3" json:"record,omitempty"`
	Workflow      *WorkflowRecord        `protobuf:"bytes,3,opt,name=workflow,proto3" json:"workflow,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type DueTimersResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Due           []*DueTimer            `protobuf:"bytes,1,rep,name=due,proto3" json:"due,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_temporaless_v1_temporaless_proto_goTypes = []any{
	...
	(*WorkflowKey)(nil),                  // 10: temporaless.v1.WorkflowKey
	(*ActivityKey)(nil),                  // 11: temporaless.v1.ActivityKey
	(*TimerKey)(nil),                     // 12: temporaless.v1.TimerKey
	(*EventKey)(nil),                     // 13: temporaless.v1.EventKey
	(*ClaimKey)(nil),                     // 14: temporaless.v1.ClaimKey
	(*ActivityFailure)(nil),              // 15: temporaless.v1.ActivityFailure
	(*ActivityAttempt)(nil),              // 16: temporaless.v1.ActivityAttempt
	(*ActivityRecord)(nil),               // 17: temporaless.v1.ActivityRecord
	(*WorkflowRecord)(nil),               // 18: temporaless.v1.WorkflowRecord
	(*TimerRecord)(nil),                  // 19: temporaless.v1.TimerRecord
	(*EventRecord)(nil),                  // 20: temporaless.v1.EventRecord
	(*ClaimRecord)(nil),                  // 21: temporaless.v1.ClaimRecord
	(*GetWorkflowRequest)(nil),           // 22: temporaless.v1.GetWorkflowRequest
	(*GetWorkflowResponse)(nil),          // 23: temporaless.v1.GetWorkflowResponse
	(*PutWorkflowRequest)(nil),           // 24: temporaless.v1.PutWorkflowRequest
	(*PutWorkflowResponse)(nil),          // 25: temporaless.v1.PutWorkflowResponse
	(*GetTimerRequest)(nil),              // 26: temporaless.v1.GetTimerRequest
	(*GetTimerResponse)(nil),             // 27: temporaless.v1.GetTimerResponse
	(*PutTimerRequest)(nil),              // 28: temporaless.v1.PutTimerRequest
	(*PutTimerResponse)(nil),             // 29: temporaless.v1.PutTimerResponse
	(*GetActivityRequest)(nil),           // 30: temporaless.v1.GetActivityRequest
	(*GetActivityResponse)(nil),          // 31: temporaless.v1.GetActivityResponse
	(*PutActivityRequest)(nil),           // 32: temporaless.v1.PutActivityRequest
	(*PutActivityResponse)(nil),          // 33: temporaless.v1.PutActivityResponse
	(*GetEventRequest)(nil),              // 34: temporaless.v1.GetEventRequest
	(*GetEventResponse)(nil),             // 35: temporaless.v1.GetEventResponse
	(*PutEventRequest)(nil),              // 36: temporaless.v1.PutEventRequest
	(*PutEventResponse)(nil),             // 37: temporaless.v1.PutEventResponse
	(*ListWorkflowsRequest)(nil),         // 38: temporaless.v1.ListWorkflowsRequest
	(*ListWorkflowsResponse)(nil),        // 39: temporaless.v1.ListWorkflowsResponse
	(*ListActivitiesRequest)(nil),        // 40: temporaless.v1.ListActivitiesRequest
	(*ListActivitiesResponse)(nil),       // 41: temporaless.v1.ListActivitiesResponse
	(*ListTimersRequest)(nil),            // 42: temporaless.v1.ListTimersRequest
	(*ListTimersResponse)(nil),           // 43: temporaless.v1.ListTimersResponse
	(*ListEventsRequest)(nil),            // 44: temporaless.v1.ListEventsRequest
	(*ListEventsResponse)(nil),           // 45: temporaless.v1.ListEventsResponse
	(*DeleteWorkflowRequest)(nil),        // 46: temporaless.v1.DeleteWorkflowRequest
	(*DeleteWorkflowResponse)(nil),       // 47: temporaless.v1.DeleteWorkflowResponse
	(*DeleteActivityRequest)(nil),        // 48: temporaless.v1.DeleteActivityRequest
	(*DeleteActivityResponse)(nil),       // 49: temporaless.v1.DeleteActivityResponse
	(*DeleteTimerRequest)(nil),           // 50: temporaless.v1.DeleteTimerRequest
	(*DeleteTimerResponse)(nil),          // 51: temporaless.v1.DeleteTimerResponse
	(*DeleteEventRequest)(nil),           // 52: temporaless.v1.DeleteEventRequest
	(*DeleteEventResponse)(nil),          // 53: temporaless.v1.DeleteEventResponse
	(*GetClaimRequest)(nil),              // 54: temporaless.v1.GetClaimRequest
...
var file_temporaless_v1_temporaless_proto_depIdxs = []int32{
	...
	12,  // 49: temporaless.v1.GetTimerRequest.key:type_name -> temporaless.v1.TimerKey
	19,  // 50: temporaless.v1.GetTimerResponse.record:type_name -> temporaless.v1.TimerRecord
	19,  // 51: temporaless.v1.PutTimerRequest.record:type_name -> temporaless.v1.TimerRecord
	11,  // 52: temporaless.v1.GetActivityRequest.key:type_name -> temporaless.v1.ActivityKey
	17,  // 53: temporaless.v1.GetActivityResponse.record:type_name -> temporaless.v1.ActivityRecord
	17,  // 54: temporaless.v1.PutActivityRequest.record:type_name -> temporaless.v1.ActivityRecord
	13,  // 55: temporaless.v1.GetEventRequest.key:type_name -> temporaless.v1.EventKey
	20,  // 56: temporaless.v1.GetEventResponse.record:type_name -> temporaless.v1.EventRecord
	20,  // 57: temporaless.v1.PutEventRequest.record:type_name -> temporaless.v1.EventRecord
	1,   // 58: temporaless.v1.ListWorkflowsRequest.status:type_name -> temporaless.v1.WorkflowStatus
	18,  // 59: temporaless.v1.ListWorkflowsResponse.records:type_name -> temporaless.v1.WorkflowRecord
	10,  // 60: temporaless.v1.ListActivitiesRequest.key:type_name -> temporaless.v1.WorkflowKey
	17,  // 61: temporaless.v1.ListActivitiesResponse.records:type_name -> temporaless.v1.ActivityRecord
	10,  // 62: temporaless.v1.ListTimersRequest.key:type_name -> temporaless.v1.WorkflowKey
	2,   // 63: temporaless.v1.ListTimersRequest.status:type_name -> temporaless.v1.TimerStatus
	19,  // 64: temporaless.v1.ListTimersResponse.records:type_name -> temporaless.v1.TimerRecord
	10,  // 65: temporaless.v1.ListEventsRequest.key:type_name -> temporaless.v1.WorkflowKey
	20,  // 66: temporaless.v1.ListEventsResponse.records:type_name -> temporaless.v1.EventRecord
	10,  // 67: temporaless.v1.DeleteWorkflowRequest.key:type_name -> temporaless.v1.WorkflowKey
	11,  // 68: temporaless.v1.DeleteActivityRequest.key:type_name -> temporaless.v1.ActivityKey
	12,  // 69: temporaless.v1.DeleteTimerRequest.key:type_name -> temporaless.v1.TimerKey
	13,  // 70: temporaless.v1.DeleteEventRequest.key:type_name -> temporaless.v1.EventKey
